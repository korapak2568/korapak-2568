...
export const MetadataNextjsVI: Metadata = {
    ...
    keywords: [
        ...
        "Phát triển Next.js Full Stack", "Tối ưu hóa SEO với Next.js", "Ứng dụng Next.js", "Phát triển ứng dụng web tùy chỉnh",
        "Ứng dụng web có thể mở rộng", "Phát triển frontend", "Ứng dụng web hiệu suất cao",
        "Ứng dụng trang đơn", "Giao diện người dùng động", "Lập trình viên full stack", "Phát triển phần mềm tùy chỉnh",
        "Lập trình viên Next.js Việt Nam", "Lập trình viên Next.js Hà Nội", "Lập trình viên Next.js Hồ Chí Minh", "Lập trình viên frontend Việt Nam",
        "Lập trình viên web Hà Nội", "Kỹ sư phần mềm", "Lập trình viên phần mềm Việt Nam",
