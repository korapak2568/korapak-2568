...
export const DevOpsMetadata: IDevOpsMetadata = {
    main: {
        ...
        keywords: [
            "DevOps technical-expertise", "software testing", "continuous integration", "CI/CD pipeline", "automated testing",
    ...
    appium: {
        ...
        openGraph: {
            ...
            description: "Automate your mobile app testing with CHORN’s Appium technical-expertise for comprehensive cross-platform testing.",
            images: [
                {
        ...
        twitter: {
            card: "summary_large_image",
            title: "Appium Testing Services | CHORN",
            description: "Ensure your mobile apps perform flawlessly with CHORN’s Appium testing technical-expertise for thorough and automated cross-platform testing.",
            images: [
    ...
    gitlab: {
        ...
        openGraph: {
            title: "GitLab DevOps Services | CHORN",
            description: "Boost your DevOps pipeline with CHORN’s GitLab technical-expertise for CI/CD, version control, and automation.",
            images: [
                {
        ...
        twitter: {
            card: "summary_large_image",
            title: "GitLab DevOps Services | CHORN",
            description: "Leverage GitLab DevOps technical-expertise from CHORN for continuous integration, version control, and workflow automation.",
            images: [
