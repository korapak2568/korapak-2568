...
export const SCALING_INFORMATION: IServiceInformation = {
  ...
  description: [
    {
      title: "",
      content: "When it's time to scale, our web development solutions are geared to support your growth journey. We " +
        ...
        "build new features, our team's expertise in both front-end and back-end technologies, alongside our " +
