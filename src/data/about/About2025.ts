...
export const About2025: IAbout = {
    ...
    description: [
        {
            title: "",
            description: "CHORN, founded by Khachornchit in March 2023, specializes in technology and software development. "+
            "Built on Khachornchit's Electrical Engineering background from Chiang Mai University and 20+ years of experience, "+ 
            "offering expertise in system architecture, business and technical analysis, software engineering, DevOps, LLM/AI, "+
            "and cloud innovation. Leads technology strategy, full-stack development, QA/Testing, and "+
            "large-scale system implementation to drive business growth with scalable, client-focused solutions. "+
            "Open to remote, hybrid, or on-site engagements in <strong>Chiang Mai, Bangkok, Thailand</strong>, "+
            "and <strong>worldwide</strong>."
        }
    ],
    stacks: [
        {
