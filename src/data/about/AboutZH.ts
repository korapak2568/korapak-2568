...
export const AboutZH: IAbout = {
    ...
    stacks: [
        {
            title: "软件开发与企业系统集成",
            description: "我们为高速发展的初创公司和以数字为核心的企业提供端到端的软件开发与企业系统集成服务。通过使用现代框架，我们构建可扩展的前端和后端系统，并集成ERP、SAP、CRM、MES以及电子商务等关键平台。我们的解决方案通过强大的API架构、Web服务（REST/SOAP）和AI/LLM能力，提升跨部门数据流动与业务自动化。从机器学习、智能合约到区块链、Web3以及去中心化应用（DApp），我们在整个技术栈中推动创新。作为战略技术合作伙伴，我们与CEO、CTO、产品负责人和创始人密切协作，加速产品交付、现代化基础设施，并推动数字化转型。"
        },
        {
            title: "系统分析和技术支持",
