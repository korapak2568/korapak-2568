...
export const AboutDE: IAbout = {
    ...
    description: [
        {
            title: "",
            description: "CHORN wurde im März 2023 entwickelt, um die Expertise in Technologie, Softwareentwicklung und Webentwicklung von K.Khachornchit zu demonstrieren, der einen Hintergrund in Elektrotechnik von der Chiang Mai Universität hat und über 20 Jahre Erfahrung in Software- und Webentwicklung mit verschiedenen Frameworks, Frontend-, Backend-, API- und Full-Stack-Entwicklung besitzt. Er verfügt über Erfahrung in Systemarchitektur, QA, Testing, Systemanalyse, DevOps, LLM/KI-Integration, Cloud-Systemimplementierung und großen Systemen, um das Geschäftswachstum mit skalierbaren und kundenorientierten Lösungen voranzutreiben. Dienstleistungen werden remote, hybrid, in Chiang Mai, Bangkok, Thailand und international angeboten."
        }
    ],
    stacks: [
        {
