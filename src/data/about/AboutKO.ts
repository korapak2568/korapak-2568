    ...
    stacks: [
        {
            ...
            description: "빠르게 성장하는 스타트업과 디지털 중심 기업을 위한 엔드투엔드 소프트웨어 개발 및 엔터프라이즈 시스템 통합 서비스를 제공합니다. 최신 프레임워크를 기반으로 확장 가능한 프론트엔드 및 백엔드 시스템을 구축하며, ERP, SAP, CRM, MES, 이커머스 등 핵심 플랫폼과의 통합을 구현합니다. 당사의 솔루션은 강력한 API 아키텍처, WebService(REST/SOAP), AI/LLM 기능을 통해 부서 간 데이터 흐름과 운영 자동화를 극대화합니다. 머신러닝, 스마트 계약, 블록체인, Web3, 분산형 애플리케이션(DApps)을 활용하여 제품 출시 속도를 높이고, 인프라를 현대화하며 디지털 전환을 주도합니다."
        },
        {
