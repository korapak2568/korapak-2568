    ...
    stacks: [
        {
            ...
            description: "우리는 빠르게 성장하는 스타트업과 디지털 중심 기업을 위해 맞춤형 엔드 투 엔드 소프트웨어 개발 및 엔터프라이즈 시스템 통합 서비스를 제공합니다. 최신 프레임워크를 활용하여 확장 가능한 프론트엔드 및 백엔드 시스템을 구축하고, ERP, SAP, CRM, MES, 이커머스 플랫폼과 같은 핵심 시스템과 통합합니다. 견고한 API 아키텍처, WebService(REST/SOAP), AI/LLM 기능을 통해 부서 간 데이터 흐름과 운영 자동화를 향상시킵니다. 머신러닝, 스마트 계약, 블록체인, Web3, 분산형 애플리케이션(DApp)까지 기술 스택 전반에 걸쳐 혁신을 실현합니다. 우리는 전략적 기술 파트너로서 CEO, CTO, 제품 책임자, 창업자와 협력하여 제품 출시를 가속화하고, 인프라를 현대화하며, 디지털 전환을 이끕니다."
        },
        {
