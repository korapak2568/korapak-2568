...
export const PrivacyPolicy: IPolicy = {
    ...
    list: [
        {
            title: "Introduction",
            description: "We respect your privacy and are committed to safeguarding your personal information. This Privacy model explains how We handle any information We may gather when you use CHORN's website, particularly regarding the use of cookies for analytics purposes.",
            isDetailed: false,
        },
        {
            ...
            details: [
                {
                    ...
                    description: "We implement reasonable security measures to protect any non-personal information collected through cookies and to ensure the integrity of CHORN's website. However, We do not collect or store personal information from visitors without consent."
                }
            ]
        },
        {
            ...
            details: [
                {
                    ...
                    description: "CHORN's Website may include links to third-party websites. Please be aware that We are not responsible for the privacy practices or the content of these third-party websites. We encourage you to review the privacy policies of any external sites you visit."
                }
            ]
        },
        {
            ...
            details: [
                {
                    ...
                    description: "We may update this Privacy model from time to time. Any modifications will be effective immediately upon posting on this page. Your continued use of the Website following any changes constitutes acceptance of the new Privacy model."
                }
            ]
        },
        {
            title: "6. Contact CHORN",
            description: "If you have any questions model this Privacy model, please contact via contact page information.",
            isDetailed: false,
        },
    ],
}