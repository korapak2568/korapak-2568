...
export const ImageUrl: IImageUrl = {
    ...
    logo: {
        lg: {
            ...
            path: `/images/logo-2025/chorn-logo-2025-circle-lg.png`
        },
        md: {
            title: `CHORN's logo md-size`,
            path: `/images/logo-2025/chorn-logo-2025-circle-md.png`
        },
        sm: {
            title: `CHORN's logo sm-size`,
            path: `/images/logo-2025/chorn-logo-2025-circle-sm.png`
        },
        business: {
        ...
        rec: {
            sm: {
                ...
                path: `/images/logo-2025/chorn-logo-2025-rec-sm.png`
            },
            lg: {
