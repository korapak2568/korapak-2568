...
export const Image: IImage = {
    ...
    serviceDetails: {
        ...
        typescript: {
            title: 'TypeScript',
            path: "/chorn-images/metadata/services/frontend-development/typescript-development-service.webp",
        },
        javascript: {
            title: 'TypeScript',
            path: "/chorn-images/metadata/services/frontend-development/javascript-development-service.webp",
        },
        dotnetcore: {
            title: 'TypeScript',
