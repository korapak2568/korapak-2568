...
export const FRONT_END_INFORMATION: IServiceLegacy = {
  ...
  description: [
    {
      title: "",
      description: "At the core of our services is a commitment to responsive web design, ensuring a consistent user experience across various devices. Our development practices are geared towards guaranteeing that your web applications adapt flawlessly to different screen sizes and devices, thus enabling a seamless experience for every user."
    },
    {
      title: "",
