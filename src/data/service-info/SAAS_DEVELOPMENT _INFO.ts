...
export const SAAS_DEVELOPMENT_INFO: IServiceLegacy = {
  ...
  description: [
    {
      title: "",
      description: "Take advantage of our proficiency in Software as a Service (SaaS) development. We deliver scalable, cloud-based solutions that cater to your software needs, ensuring that your applications are not just user-friendly but also easily accessible and scalable."
    },
    {
      title: "",
