...
export const DEVOPS_AND_TESTING_INFO: IServiceLegacy = {
  ...
  description: [
    {
      title: "",
      description: "In today's fast-paced digital " +
  ...
  stacks: [
    ...
    },
    {
      ...
      description: "CI/CD pipelines, powered by " +
    ...
    {
      title: "Automation",
      description: "DevOps promotes automation of repetitive tasks, reducing manual errors and " +
    ...
    },
    {
      ...
      description: "Tools like Docker and Kubernetes facilitate the " +
    ...
    },
    {
      ...
      description: "As mobile applications gain prominence, tools like " +
