...
export const MICROSERVICES_INFO: IService2025 = {
  ...
  description: [
    {
      title: "",
      description: "Microservices technology is revolutionizing the landscape of custom software development across numerous " +
    ...
    {
      title: "",
      description: "In all these sectors, microservices architecture enables a more modular, scalable, and agile approach to " +
  ...
  stacks: [
    ...
    },
    {
      ...
      description: "CRM systems can utilize microservices for " +
        "managing customer " +
    ...
    },
    {
      ...
      description: "POS systems often consist of microservices for inventory " +
    ...
    },
    {
      ...
      description: "Systems handling bookings for travel, accommodation, events, or " +
    ...
    },
    {
      ...
      description: "In healthcare, microservices can be employed for patient records, " +
    ...
    },
    {
      ...
      description: "Microservices are valuable in financial technology for " +
    ...
    },
    {
      ...
      description: "Managing the supply chain involves various components like " +
    ...
    },
    {
      ...
      description: "Microservices play a pivotal role in EdTech platforms by " +
