...
export const GalleryDE: IGallery = {
    slides: [
        {
            title: "Fleksible Arbeitsräume",
            description: "Flexible Arbeitsplätze nach Kundenwunsch, gelegen in Bangkok, Thailand, in der Nähe von BTS- und MRT-Stationen, wichtigen Sehenswürdigkeiten und führenden Einkaufszentren wie Siam Paragon, Central World und ICON Siam. Bereit für Remote-Arbeit, Hybrid-Arbeit oder Vor-Ort-Arbeit in Chiang Mai, Bangkok, Thailand und im Ausland.",
    ...
    global: {
        ...
        description: "CHORN verfügt über Erfahrung mit internationalen Reisen für Schulungen, internationale Arbeitsstudienreisen sowohl in der ASEAN als auch in den USA, Durchführung von Workshops und ist bereit für Reisen im In- und Ausland. CHORN bietet Fernarbeit, Hybridarbeit und bürobasierte Arbeit in Chiang Mai, Bangkok, Thailand und international an.",
