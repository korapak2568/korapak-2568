...
export const GalleryJA: IGallery = {
    "slides": [
        {
            title: "柔軟な作業空間",
            description: "顧客のニーズに合わせた柔軟な職場環境、タイのバンコクに位置し、BTSやMRT駅、主要なランドマーク、サイアムパラゴン、セントラルワールド、ICONサイアムなどの一流ショッピングセンターに近接しています。リモートワーク、ハイブリッドワーク、またはチェンマイ、バンコク、タイ国内および海外での勤務に対応可能です。",
