...
export const FrontEndVI: IFrontEnd = {
    ...
    span: "Kinh nghiệm Front-End Xuất sắc",
    subTitle: "",
        ...
        "faqs": [
            {
                ...
                "answer": "Next.js là một framework React cung cấp khả năng render phía máy chủ và tạo trang tĩnh cho các ứng dụng web được tối ưu hóa."
            },
            {
                "question": "Render phía máy chủ trong Next.js cải thiện hiệu suất như thế nào?",
                "answer": "Render phía máy chủ cải thiện hiệu suất bằng cách pre-render các trang trên máy chủ, giảm thời gian render phía máy khách."
            },
            {
                "question": "Tạo trang tĩnh trong Next.js là gì?",
                "answer": "Tạo trang tĩnh pre-render các trang tại thời điểm build, cung cấp thời gian tải nhanh và cải thiện SEO."
            }
        ]
    },
        ...
        "faqs": [
            {
                ...
                "answer": "React.js là một thư viện JavaScript để xây dựng giao diện người dùng, được duy trì bởi Facebook."
            },
            {
                "question": "React Hooks là gì?",
                "answer": "React Hooks là các hàm cho phép bạn sử dụng state và các tính năng vòng đời trong các component hàm."
            },
            {
                "question": "DOM ảo hoạt động như thế nào?",
                "answer": "DOM ảo chỉ cập nhật các phần tử đã thay đổi, cải thiện hiệu suất của ứng dụng."
            }
        ]
    },
    typescript: {
        ...
        "faqs": [
            {
                ...
                "answer": "TypeScript là một tập cha của JavaScript, bổ sung kiểu tĩnh và các tính năng nâng cao khác để cải thiện phát triển."
            },
            {
                "question": "Tại sao sử dụng TypeScript thay vì JavaScript?",
                "answer": "Kiểu tĩnh và các công cụ mạnh mẽ của TypeScript phát hiện lỗi sớm, cải thiện chất lượng mã và nâng cao năng suất của nhà phát triển."
            },
            {
                "question": "TypeScript có thể làm việc với các framework JavaScript không?",
                "answer": "Có, TypeScript hoàn toàn tương thích với các framework JavaScript như React, Angular và Vue.js."
            }
        ]
    },
    vue: {
        ...
        "features": [
            ...
            },
            {
                ...
                "list": [
                    ...
                    "Tính năng thời gian thực (ví dụ: trò chuyện, thông báo)",
        ...
        "faqs": [
            {
                ...
                "answer": "JavaScript là ngôn ngữ lập trình động thường được sử dụng để tạo các ứng dụng web tương tác."
            },
            {
                "question": "Tại sao sử dụng JavaScript cho phát triển web?",
                "answer": "JavaScript cung cấp tính linh hoạt, thư viện phong phú và khả năng tương thích trên các trình duyệt, khiến nó trở thành ngôn ngữ ưa chuộng của các nhà phát triển web."
            },
            {
                "question": "Những frameworks nào được xây dựng trên JavaScript?",
                "answer": "Các frameworks JavaScript phổ biến bao gồm React, Angular và Vue.js."
            }
        ]
    },
