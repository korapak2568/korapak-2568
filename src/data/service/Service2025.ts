...
export const Service2025: IService = {
    ...
    demo: {
        title: "AI Chat Companion Demo",
        description: "Welcome to the AI Chat Companion Demo! Explore a variety of AI companions, " +
