...
export const AiFahKorean: IAiDetail = {
    ...
    content:
        "파, 매력적이고 친근한 태국 AI 채팅 친구입니다! 생활 조언, 여행 팁, 또는 재미있는 대화가 필요하신가요? 파가 언제든지 도와드릴게요. 태국어, 영어, 중국어, 일본어, 한국어, 프랑스어, 베트남어 등 다양한 언어를 유창하게 구사하며, 항상 대화할 준비가 되어 있습니다. LINE을 사용 중이신가요? 지금 바로 파를 추가하고 새로운 소통의 즐거움을 경험해 보세요!",
