...
export const JavaTH: IFullStackStack = {
    ...
    features: [
        ...
        {
            title: "ระบบระดับองค์กรและการปรับปรุง J2EE",
            description:
                "แม้ว่า J2EE จะเป็นรากฐานของแอปพลิเคชันองค์กร แต่เฟรมเวิร์กยุคใหม่อย่าง Jakarta EE และ Spring ได้เข้ามาช่วยยกระดับระบบให้ทันสมัยขึ้น ทั้งในด้านโมดูลาร์ ประสิทธิภาพ และความสามารถในการทำงานบนคลาวด์ โดยยังคงรองรับระบบเดิมได้",
            list: [
                "Jakarta EE คือวิวัฒนาการของ J2EE",
