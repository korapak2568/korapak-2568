...
export const FullStackVI: IFullStack = {
    ...
    span: "Kinh nghiệm Back-End & API Xuất sắc",
    subTitle: "",

    dotnetcore: {
        title: ".NET Core C#",
        description: ".NET Core C# là một framework đa năng, mã nguồn mở và đa nền tảng được phát triển bởi Microsoft. Nó cho phép các nhà phát triển xây dựng các ứng dụng hiện đại, hiệu suất cao và có thể mở rộng trên nhiều nền tảng khác nhau, bao gồm Windows, macOS và Linux. Với sự hỗ trợ để xây dựng các ứng dụng web, API và microservices, .NET Core C# cung cấp một môi trường mạnh mẽ cho các giải pháp cấp doanh nghiệp.",
        ...
        features: [
            {
                title: "Phát triển C# .NET Core",
                description: ".NET Core C# là một framework mạnh mẽ và mã nguồn mở để xây dựng các ứng dụng hiệu suất cao. Với thiết kế mô-đun và hỗ trợ nhiều ngôn ngữ lập trình, .NET Core C# là lý tưởng để phát triển các ứng dụng web, API và microservices có thể chạy trên bất kỳ nền tảng nào.",
                list: []
            },
            {
                title: "ASP.NET Core C#",
                description: "ASP.NET Core C# là một framework đa nền tảng, hiệu suất cao để xây dựng các ứng dụng hiện đại, dựa trên đám mây và kết nối internet. Nó đặc biệt phù hợp để xây dựng các ứng dụng web, API và microservices với sự tập trung vào hiệu suất, bảo mật và khả năng mở rộng.",
                list: [
                    "Đa nền tảng",
                    "Hiệu suất cao",
            ...
            {
                title: "C# .NET Core",
                description: "C# .NET Core là ngôn ngữ chính được sử dụng để phát triển các ứng dụng trong .NET Core C#. Nổi bật với cú pháp đơn giản, linh hoạt và các tính năng hiện đại, C# cho phép các nhà phát triển xây dựng các ứng dụng mạnh mẽ, dễ bảo trì và có thể mở rộng một cách dễ dàng.",
                list: [
                    "Cú pháp hiện đại",
        ...
        faqs: [
            {
                question: ".NET Core C# là gì?",
                answer: ".NET Core C# là một framework mã nguồn mở và đa nền tảng để xây dựng các ứng dụng hiện đại chạy trên Windows, macOS và Linux."
            },
            {
                question: "ASP.NET Core C# được sử dụng để làm gì?",
                answer: "ASP.NET Core C# là một framework để xây dựng các ứng dụng web, API và microservices với hiệu suất cao và khả năng đa nền tảng."
            },
            {
                question: "Tại sao C# .NET Core là một lựa chọn tốt cho phát triển?",
                answer: "C# là một ngôn ngữ lập trình hiện đại, linh hoạt với nhiều tính năng, làm cho nó trở thành sự lựa chọn lý tưởng để phát triển các ứng dụng có thể mở rộng và dễ bảo trì trong .NET Core C#."
            }
        ],
    },
    go: {
    ...
    java: {
        ...
        features: [
            {
                title: "Phát triển Java Spring Boot",
                description: "Java là một ngôn ngữ lập trình đa năng cấp cao nổi tiếng với khả năng di động, mạnh mẽ và hiệu suất. Spring Boot là một framework đơn giản hóa việc phát triển các ứng dụng sẵn sàng cho sản xuất. Kotlin, một ngôn ngữ lập trình hiện đại, tương tác với Java, nâng cao năng suất và an toàn.",
                list: []
            },
            {
                title: "Hệ sinh thái mạnh mẽ",
                description: "Sự kết hợp của Java và Spring Boot cung cấp một hệ sinh thái mạnh mẽ để xây dựng các ứng dụng có khả năng mở rộng, an toàn và hiệu suất cao. Spring Boot đơn giản hóa quá trình thiết lập và phát triển, cho phép phát triển và triển khai nhanh chóng.",
                list: [
            ...
            {
                title: "Tính năng ngôn ngữ hiện đại",
                description: "Kotlin cung cấp các tính năng ngôn ngữ hiện đại như an toàn null, hàm mở rộng và coroutines, khiến nó trở thành lựa chọn ưa thích cho các dự án mới. Khả năng tương tác liền mạch với Java cho phép các nhà phát triển tận dụng các thư viện và framework Java hiện có trong khi vẫn tận hưởng những cải tiến của Kotlin.",
                list: []
            },
            {
                title: "Giải pháp cấp doanh nghiệp",
                description: "Java và Spring Boot được sử dụng rộng rãi trong môi trường doanh nghiệp do độ tin cậy và khả năng mở rộng của chúng. Các công nghệ này cung cấp năng lượng cho các ứng dụng quan trọng trong nhiều ngành công nghiệp khác nhau, đảm bảo rằng chúng có thể xử lý các hoạt động quy mô lớn một cách dễ dàng.",
                list: []
            }
        ],
        faqs: [
            {
                ...
                answer: "Spring Boot là một framework để xây dựng các ứng dụng độc lập, dựa trên Spring ở cấp độ sản xuất."
            },
            {
                question: "Tại sao sử dụng Kotlin với Java?",
                answer: "Kotlin hoàn toàn tương thích với Java và cung cấp các tính năng ngôn ngữ hiện đại cho mã ngắn gọn và an toàn hơn."
            },
            {
                question: "Java có những lợi thế gì?",
                answer: "Java nổi tiếng với sự mạnh mẽ, khả năng mở rộng và hệ sinh thái rộng lớn cho các ứng dụng doanh nghiệp."
            }
        ],
    },
    nodejs: {
