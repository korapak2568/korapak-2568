...
export const DevOpsTH: IDevOps = {
    ...
    services: {
        ...
        descriptions: [
            "CHORN มีประสบการณ์ในการเรียนรู้อย่างต่อเนื่องเพื่อเพิ่มประสิทธิภาพโครงสร้างพื้นฐานคลาวด์ และปรับปรุงการส่งมอบซอฟต์แวร์ด้วยความเชี่ยวชาญด้านคลาวด์และ DevOps " +
            "การปรับปรุงกระบวนการทางธุรกิจในการทำงานแบบอัตโนมัติ ขยายขนาด และรักษาความปลอดภัยให้กับสภาพแวดล้อมคลาวด์ โดยใช้แนวปฏิบัติ DevOps สมัยใหม่ " +
            "ตั้งแต่แอปพลิเคชันที่ใช้คลาวด์เป็นพื้นฐานไปจนถึงการทำงานอัตโนมัติของโครงสร้างพื้นฐาน เรามั่นใจในประสิทธิภาพ ความน่าเชื่อถือ และความปลอดภัย",

            "ศึกษาเรียนรู้ ปรับปรุงการใช้งาน และปรับเปลี่ยนระบบให้เป็นอัตโนมัติมากขึ้นด้วยการใช้งาน Infrastructure as Code (IaC), Terraform และ AWS CloudFormation สำหรับการจัดการคลาวด์ที่ขยายขนาดได้ " +
            "ประสบการณ์ในกลยุทธ์มัลติคลาวด์ต่างๆ เช่น AWS, Azure, Google Cloud, และ DigitalOcean เพื่อให้มั่นใจในการใช้คลาวด์ด้วยความยืดหยุ่นและความทนทาน",

            "เพิ่มประสิทธิภาพไปป์ไลน์ CI/CD โดยใช้ GitLab, GitHub Actions และ Jenkins พร้อมผสมผสานความปลอดภัย (DevSecOps) " +
            "เพื่อสร้างซอฟต์แวร์ที่แข็งแกร่งและปลอดภัยในระดับใหญ่"
        ],
        items: [
            {
                title: "โครงสร้างพื้นฐานคลาวด์และการทำงานอัตโนมัติ",
                description: "สร้างและจัดการสภาพแวดล้อมคลาวด์โดยใช้ Terraform, AWS CloudFormation และ Kubernetes"
            },
            {
                title: "CI/CD และ DevSecOps",
                description: "ทำให้ไปป์ไลน์การส่งมอบซอฟต์แวร์เป็นอัตโนมัติด้วย GitLab, Jenkins และ GitHub Actions พร้อมผสมผสานแนวปฏิบัติด้านความปลอดภัยที่ดีที่สุด"
            },
            {
                title: "คอนเทนเนอร์ไรเซชันและการจัดการ",
                description: "ปรับใช้และจัดการแอปพลิเคชันที่ใช้คลาวด์เป็นพื้นฐานโดยใช้ Docker และ Kubernetes"
            },
            {
                title: "การติดตามและการสังเกตการณ์",
                description: "รับข้อมูลเชิงลึกแบบเรียลไทม์ด้วย Prometheus, Grafana และโซลูชันการติดตามที่ใช้คลาวด์เป็นพื้นฐาน"
            }
        ]
    }
}
