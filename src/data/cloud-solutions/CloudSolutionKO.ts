...
export const CloudSolutionKO: ICloudSolution = {
    ...
    descriptions: [
        {
            title: "비즈니스 운영 혁신",
            span: "디지털 트랜스포메이션 가속화",
            description: "전략적 아키텍처와 시스템 분석을 통해 측정 가능한 비즈니스 성과를 제공하는 클라우드 인프라의 잠재력을 최대한 활용하세요.",
            features: []
        },
        {
            title: "데이터 기반 의사결정",
    ...
    sections: [
        {
            title: "전략적 클라우드 선택",
            span: "맞춤형 클라우드 인프라",
            description: "클라우드 마이그레이션의 성공은 특정 비즈니스 요구 사항에 맞는 올바른 플랫폼을 선택하는 데 달려 있습니다. 기존 인프라를 개선하든 새 시스템을 처음부터 구축하든, 이상적인 클라우드 환경은 비즈니스 목표와 완벽하게 일치해야 합니다. 클라우드 네이티브, 하이브리드 또는 멀티 클라우드 환경은 확장성 요구 사항, 규정 준수 요구 사항 및 운영 목표에 따라 각각 고유한 이점을 제공합니다.",
        },
        {
            title: "AWS",
