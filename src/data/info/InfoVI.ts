...
import {AiCompanionVI} from "@/data/ai/companions/AiCompanionVI";
import {ServicePackagesVI} from "@/data/service-packages/ServicePackagesVI";

export const InfoVI: IInfo = {
    AiCompanions: AiCompanionVI,
