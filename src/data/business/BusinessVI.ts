...
export const BusinessVI: IBusiness = {
    span: "Học và phát triển phần mềm cho các ngành công nghiệp khác nhau",
    title: "Phát triển phần mềm cho các lĩnh vực kinh doanh",
    domains: [
        {
            label: "Tiếp thị số",
