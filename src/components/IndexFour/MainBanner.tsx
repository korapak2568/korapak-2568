                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        <div
                          ...
                          style={{
                            backgroundImage: `url(https://cdn.chorn.in.th/obsolete/main-slider/main-slider-1.jpg)`,
                          }}
                        ></div>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        <div
                          className="main-slider-image"
                          style={{
                            backgroundImage: `url(https://cdn.chorn.in.th/obsolete/main-slider/main-slider-2.jpg)`,
                          }}
                        ></div>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        <div
                          className="main-slider-image"
                          style={{
                            backgroundImage: `url(https://cdn.chorn.in.th/obsolete/main-slider/main-slider-3.jpg)`,
                          }}
                        ></div>
                      </div>
                    </div>
