    ...
    <>
      <div className="main-banner">
        <div 
          ...
          style={{
            backgroundImage: `url(/images/main-banner-bg-2.jpg)`,
          }}
        >
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6">
                    <div className="main-banner-image">
                      <Image
                        src="/images/banner/banner-image-2.png"
                        alt="image"
                        width={985}
                        height={1040}
                      />
        ...
        <div className="main-banner-shape">
          ...
          <div className="shape-7">
            <Image
              src="/images/banner/banner-shape-4.png"
              alt="image"
              width={55}
              height={55}
            />
          ...
          <div className="shape-8">
            <Image
              src="/images/banner/banner-shape-5.png"
              alt="image"
              width={56}
              height={56}
            />
