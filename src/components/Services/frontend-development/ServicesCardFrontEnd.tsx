                ...
                <div className="container">
                    <div className="row justify-content-md-center">
                        ...
                        <div className={'add-web-content'}>
                            ...
                            <ul>
                                {InfoTranslation[currentTranslate.value].FrontEnd.services.items.map((item, index) => (
                                    <li key={index}>
                        ...
                        {InfoTranslation[currentTranslate.value].FrontEnd.stacks.slice(0, -2).map((item: IFrontEndStack, index: number) => (
