        ...
        <>
            <div className="faq-accordion mt-3">
                <Accordion allowZeroExpanded preExpanded={[
                    `${sanitizeUUID(InfoTranslation[currentTranslate.value].FrontEnd.angular.faqs[0].question)}`
                ]}>
                    {InfoTranslation[currentTranslate.value].FrontEnd.angular.faqs.map((item, index: number) => (
