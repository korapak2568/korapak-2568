...
export default function ServicesDetailsTypeScript({lang, stack, frontEnd, fullStack}: { lang: string, stack: IFrontEndStack, frontEnd: IFrontEnd, fullStack: IFullStack }) {
    return (
