        ...
        <>
            <div className="faq-accordion mt-3">
                <Accordion allowZeroExpanded preExpanded={[
                    `${InfoTranslation[currentTranslate.value].DevOps.jenkins.faqs[0].question}`
                ]}>
                    {InfoTranslation[currentTranslate.value].DevOps.jenkins.faqs.map((item, index: number) => (
...
export default ServiceFaqJenkins;
