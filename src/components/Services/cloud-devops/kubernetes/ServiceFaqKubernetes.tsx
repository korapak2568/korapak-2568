        ...
        <>
            <div className="faq-accordion mt-3">
                <Accordion allowZeroExpanded preExpanded={[
                    `${InfoTranslation[currentTranslate.value].DevOps.kubernetes.faqs[0].question}`
                ]}>
                    {InfoTranslation[currentTranslate.value].DevOps.kubernetes.faqs.map((item, index: number) => (
