        ...
        <>
            <div className="faq-accordion mt-3">
                <Accordion allowZeroExpanded preExpanded={[
                    `${sanitizeUUID(InfoTranslation[currentTranslate.value].FullStack.dotnetcore.faqs[0].question)}`
                ]}>
                    {InfoTranslation[currentTranslate.value].FullStack.dotnetcore.faqs.map((item, index: number) => (
