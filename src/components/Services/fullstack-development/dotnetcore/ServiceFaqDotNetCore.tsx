        ...
        <>
            <div className="faq-accordion mt-3">
                <Accordion allowZeroExpanded preExpanded={[
                    `${sanitizeUUID(InfoTranslation[locale.value].FullStack.dotnetcore.faqs[0].question)}`
                ]}>
                    {InfoTranslation[locale.value].FullStack.dotnetcore.faqs.map((item, index: number) => (
