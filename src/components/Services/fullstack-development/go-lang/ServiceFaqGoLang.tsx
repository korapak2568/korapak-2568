        ...
        <>
            <div className="faq-accordion mt-3">
                <Accordion allowZeroExpanded preExpanded={[
                    `${sanitizeUUID(InfoTranslation[currentTranslate.value].FullStack.go.faqs[0].question)}`
                ]}>
                    {InfoTranslation[currentTranslate.value].FullStack.go.faqs.map((item, index: number) => (
