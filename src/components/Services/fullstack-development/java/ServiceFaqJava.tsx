        ...
        <>
            <div className="faq-accordion mt-3">
                <Accordion allowZeroExpanded preExpanded={[
                    `${sanitizeUUID(InfoTranslation[currentTranslate.value].FullStack.java.faqs[0].question)}`
                ]}>
                    {InfoTranslation[currentTranslate.value].FullStack.java.faqs.map((item, index: number) => (
