        ...
        <>
            <div className="faq-accordion mt-3">
                <Accordion allowZeroExpanded preExpanded={[
                    `${sanitizeUUID(InfoTranslation[currentTranslate.value].FullStack.nodejs.faqs[0].question)}`
                ]}>
                    {InfoTranslation[currentTranslate.value].FullStack.nodejs.faqs.map((item, index: number) => (
...
export default ServiceFaqNodejs;
