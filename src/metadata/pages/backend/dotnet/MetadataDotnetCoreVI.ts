...
export const MetadataDotnetCoreVI: Metadata = {
    ...
    openGraph: {
        ...
        url: metadataLink(LanguageCode.vi, MetaLinks.backend.dotnetcore).alternates.canonical,
        type: "website"
    },
    twitter: {
    ...
    keywords: [
        ...
        "Ứng dụng .NET Core C# cho doanh nghiệp", "Phát triển ASP.NET Core C#", "Ứng dụng web .NET Core C#",
        "Phát triển phần mềm tùy chỉnh",

        "Ứng dụng web mở rộng", "Phát triển backend", "Giải pháp phần mềm cho doanh nghiệp", "Phát triển Full Stack",
        "Ứng dụng hiệu suất cao", "Ứng dụng web tùy chỉnh", "Phát triển API",

        "Lập trình viên .NET Core C# Thái Lan", "Lập trình viên .NET Core C# Bangkok", "Lập trình viên .NET Core C# Chiang Mai",
