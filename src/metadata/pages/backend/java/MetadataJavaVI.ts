...
export const MetadataJavaVI: Metadata = {
    ...
    keywords: [
        ...
        "Ứng dụng Java Spring Boot", "Phát triển Java cho doanh nghiệp", "Microservices Spring Boot",
        "Phát triển phần mềm tùy chỉnh", "Ứng dụng web có thể mở rộng", "Phát triển backend", "Giải pháp phần mềm doanh nghiệp",
        "Ứng dụng hiệu suất cao", "Ứng dụng web Java", "Phát triển Microservices", "Phát triển API",
        "Nhà phát triển Spring Boot Thái Lan", "Nhà phát triển Java Thái Lan", "Nhà phát triển Java Bangkok",
        "Nhà phát triển Java Chiang Mai", "Nhà phát triển backend Thái Lan", "Kỹ sư phần mềm", "Nhà phát triển phần mềm Thái Lan",
