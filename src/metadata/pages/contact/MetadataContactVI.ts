...
export const MetadataContactVI: Metadata = {
    ...
    alternates: metadataLink(LanguageCode.vi, MetaLinks.contact).alternates,
    authors: [
        {
            name: "CHORN"
        }
    ...
    openGraph: {
        ...
        images: metadataLink(LanguageCode.vi, MetaLinks.contact).openGraph.images,
        url: metadataLink(LanguageCode.vi, MetaLinks.contact).alternates.canonical,
        type: "website"
    },
    twitter: {
        ...
        images: metadataLink(LanguageCode.vi, MetaLinks.contact).twitter.images,
    },
}