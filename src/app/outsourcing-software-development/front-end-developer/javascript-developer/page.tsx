...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: "https://chorn.in.th/outsourcing-software-development/full-stack-developer/javascript-javascript-developer/",
    },
    openGraph: {
        ...
        images: [
            {
                url: "https://chorn.in.th/chorn-images/metadata/services/fullstack-development/javascript-development-service.webp",
                width: 1200,
                height: 630,
                alt: "CHORN JavaScript Development Banner",
            },
        ],
        url: "https://chorn.in.th/outsourcing-software-development/full-stack-developer/javascript-javascript-developer/",
        type: "website",
    },
    twitter: {
        ...
        images: [
            "https://chorn.in.th/chorn-images/metadata/services/fullstack-development/javascript-development-service.webp",
        ],
    },
    keywords: [
...
const Page = () => {
    ...
    return (
        <>
            ...
            <PageBanner
                pageTitle={Info.FrontEnd.javascript.features[0].title}
                homePageUrl="/"
                homePageText="Home"
