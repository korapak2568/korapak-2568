...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
                url: "https://chorn.in.th/chorn-images/metadata/services/devops-testing/soapui.webp",
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        images: [
            "https://chorn.in.th/chorn-images/metadata/services/devops-testing/soapui.webp",
        ],
    },
    keywords: [
...
const Page = () => {
    ...
    return (
        <>
            ...
            <PageBanner
                pageTitle={Info.DevOps.additions[7].details[0].title}
                homePageUrl="/"
                homePageText="Home"
