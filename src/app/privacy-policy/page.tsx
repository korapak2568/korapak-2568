      ...
      <div className="privacy-policy-area ptb-100">
        <div className="container">
          <div className="privacy-content">
            <h3>1. Welcome To Renex Privacy Policy</h3>
            <p>
            ...
            <p>
              We may collect different from or about you depending on how you
              use the Services. Below are some examples to help you better
              understand the we collect.
            </p>
            ...
            <p>
              You can choose not to provide certain to us, but you may not be
            ...
            <ol>
              ...
              <li>
                ...
                and other types of local storage. Your wireless device may also
                allow you to control whether location or other is collected and
                shared. You can manage Adobe’s LSOs through their Website
